// parallel (no wraps, 64-byte text pad between worker_stub and main)
#include <stdint.h>
...
extern "C" __attribute__((retain, noinline)) void __pad64(void) {
    __asm__ volatile(
        "nop\n\t" "nop\n\t" "nop\n\t" "nop\n\t"
        "nop\n\t" "nop\n\t" "nop\n\t" "nop\n\t"
        "nop\n\t" "nop\n\t" "nop\n\t" "nop\n\t"
...
__attribute__((used)) void (*const __pad64_ref)(void) = __pad64;
