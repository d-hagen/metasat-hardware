module VX_csr_unit import VX_gpu_pkg::*; #(
    ...
    localparam DATAW      = 1 + ((($clog2(4)) != 0) ? ($clog2(4)) : 1) + NUM_LANES + 32 + $clog2(32) + 1 + NUM_LANES * 32 + PID_WIDTH + 1 + 1;
    ...
    wire [12-1:0] csr_addr = execute_if.data.imm[12-1:0];
    wire [$clog2(32)-1:0] csr_imm = execute_if.data.imm[12 +: $clog2(32)];
    ...
    for (genvar i = 0; i < NUM_LANES; ++i) begin
        assign commit_if.data.data[i] = 32'(csr_commit_data[i]);
    end
endmodule
