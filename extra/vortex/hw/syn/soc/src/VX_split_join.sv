module VX_split_join import VX_gpu_pkg::*; #(
    ...
    input  wire [((($clog2(4)) != 0) ? ($clog2(4)) : 1)-1:0]     stack_wid,
    output wire [((($clog2((((4-1) != 0) ? (4-1) : 1))) != 0) ? ($clog2((((4-1) != 0) ? (4-1) : 1))) : 1)-1:0] stack_ptr
);
    wire [(4+(32-1))-1:0] ipdom_data [4-1:0];
    wire [((($clog2((((4-1) != 0) ? (4-1) : 1))) != 0) ? ($clog2((((4-1) != 0) ? (4-1) : 1))) : 1)-1:0] ipdom_q_ptr [4-1:0];
    wire ipdom_set [4-1:0];
    wire [(4+(32-1))-1:0] ipdom_q0 = {split.then_tmask | split.else_tmask, (32-1)'(0)};
    wire [(4+(32-1))-1:0] ipdom_q1 = {split.else_tmask, split.next_pc};
    ...
    VX_pipe_register #(
        .DATAW  (1 + 1 + 1 + ((($clog2(4)) != 0) ? ($clog2(4)) : 1) + 4 + (32-1)),
        .DEPTH  (1),
        .RESETW (1)
    ) pipe_reg (
        .clk      (clk),
