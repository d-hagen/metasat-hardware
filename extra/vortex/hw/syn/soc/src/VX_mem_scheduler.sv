module VX_mem_scheduler #(
    ...
    wire [1-1:0] coalescer_reset;                        
    VX_reset_relay #(.N(1), .MAX_FANOUT(0)) __coalescer_reset ( 
        .clk     (clk),                         
        .reset   (reset),                         
        .reset_o (coalescer_reset)                          
    );
        VX_mem_coalescer #(
    ...
    VX_elastic_buffer #(
        ...
        .SIZE    ((((MEM_OUT_BUF) < (2)) ? (MEM_OUT_BUF) : (2))),
    ...
    VX_elastic_buffer #(
        ...
        .SIZE    ((((CORE_OUT_BUF) < (2)) ? (CORE_OUT_BUF) : (2))),
