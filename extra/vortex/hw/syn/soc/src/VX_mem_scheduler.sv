module VX_mem_scheduler #(
    ...
    localparam MEM_TAG_WIDTH   = (((MEM_TAG_ID) != 0) ? (MEM_TAG_ID) : 1);
    localparam BATCH_SEL_WIDTH = (((BATCH_SEL_BITS) != 0) ? (BATCH_SEL_BITS) : 1);
    ...
    for (genvar i = 0; i < NUM_BANKS; ++i) begin
        VX_elastic_buffer #(
            ...
            .SIZE    ((((MEM_OUT_REG) < (2)) ? (MEM_OUT_REG) : (2))),
    ...
    VX_elastic_buffer #(
        ...
        .SIZE    ((((CORE_OUT_REG) < (2)) ? (CORE_OUT_REG) : (2))),
