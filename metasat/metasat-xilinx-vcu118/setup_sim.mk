...
ifeq ($(TEST),parallel)
...
else ifeq ($(TEST),parallel-nowrap-pad)
	@echo "=== Selecting parallel-nowrap-pad test (nowrap + 64B text pad to shift main) ==="
	cp $(EVAL_DIR)/evaluation/gpu-evaluation-parallel-nowrap-pad.srec $(SIM_DIR)/ram.srec
	...
	@echo "  bare | nospawn | spawn1 | parallel | evaluation | evaluation-light | bare-nowrap | nospawn-nowrap | spawn1-nowrap | parallel-nowrap | parallel-nowrap-light"
	@exit 1
endif
