...
package cfgmap is
  ...
  constant MIG_HSINDEX	    : integer := 2;
  constant GPU_HSINDEX      : integer := 3;
  
  -- AHB slave address
  constant L2C_HADDR        : integer := 16#000#;
  constant L2C_HMASK        : integer := 16#800#;
  constant L2C_IOADDR       : integer := 16#F00#;
  constant MEM_HADDR        : integer := 16#000#;
  constant MEM_HMASK        : integer := 16#800#;
  constant GPU_IOADDR       : integer := 16#800#;
  constant GPU_IOMASK       : integer := 16#FFF#;
  ...
  constant APBUART_PINDEX   : integer := 7;
  ...
  constant APBUART_PADDR    : integer := 16#E00#;
...
--  constant LOGAN1_PMASK     : integer := 16#F00#;
  ...
  constant APBUART_PIRQ     : integer := 7;
